...
/*
  Note: This example uses the DDNS_Generic library (https://github.com/khoih-prog/DDNS_Generic)
        You can access this WebServer by either localIP:LISTEN_PORT such as 192.169.2.100:5990
        or DDNS_Host:LISTEN_PORT, such as account.duckdns.org:5990
*/
...
#define FRIENDLY_NAME       "SAMD-W5X00"  // this name will appear in your router port forwarding section
