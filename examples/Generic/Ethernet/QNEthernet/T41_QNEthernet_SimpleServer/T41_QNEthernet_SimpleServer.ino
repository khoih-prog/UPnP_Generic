/****************************************************************************************************************************
  T41_QNEthernet_SimpleServer.ino
...
#define FRIENDLY_NAME       "T41-QNEth"  // this name will appear in your router port forwarding section
...
void setup()
{
  ...
  Serial.print("\nStart T41_QNEthernet_SimpleServer on "); Serial.println(BOARD_NAME);
