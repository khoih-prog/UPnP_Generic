...
#define FRIENDLY_NAME       "Portenta_H7-LED-WIFI"  // this name will appear in your router port forwarding section
...
{ 
  ...
  Serial.print("\nStart Portenta_H7_PWM_LEDServer on "); Serial.print(BOARD_NAME);
