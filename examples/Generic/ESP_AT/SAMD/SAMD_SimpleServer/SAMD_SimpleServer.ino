...
/*
  Note: This example uses the DDNS_Generic library (https://github.com/khoih-prog/DDNS_Generic)
        You can access this WebServer by either localIP:LISTEN_PORT such as 192.169.2.100:5990/?percentage=20
        or DDNS_Host:LISTEN_PORT, such as account.duckdns.org:5990/?percentage=20
*/
...
#define LISTEN_PORT         5990
#define LEASE_DURATION      36000  // seconds
#define FRIENDLY_NAME       "SAMD-WIFI-ESPAT"  // this name will appear in your router port forwarding section
