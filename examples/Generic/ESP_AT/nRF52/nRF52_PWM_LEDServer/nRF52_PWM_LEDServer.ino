...
/*
  Note: This example uses the DDNS_Generic library (https://github.com/khoih-prog/DDNS_Generic)
        ...
        or DDNS_Host:LISTEN_PORT, such as account.duckdns.org:7053/?percentage=20
*/
...
#define LISTEN_PORT         7053
#define LEASE_DURATION      36000  // seconds
#define FRIENDLY_NAME       "NRF52-LED-WIFI-ESPAT"  // this name will appear in your router port forwarding section
