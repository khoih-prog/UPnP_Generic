...
/*
  Note: This example uses the DDNS_Generic library (https://github.com/khoih-prog/DDNS_Generic)
        You can access this WebServer by either localIP:LISTEN_PORT such as 192.169.2.100:8267/?percentage=20
        or DDNS_Host:LISTEN_PORT, such as account.duckdns.org:8267/?percentage=20
*/
...
#define LISTEN_PORT         8267
#define LEASE_DURATION      36000  // seconds
#define FRIENDLY_NAME       "ESP8266-LED-WIFI"  // this name will appear in your router port forwarding section
...
{ 
  ...
  Serial.println("\nStart PWM_LEDServer_ESP8266 on " + String(ARDUINO_BOARD));
